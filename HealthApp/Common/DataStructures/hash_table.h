...
__DS_FUNC_PREFIX_INL DataType* __htable_iter_next_##id(TableType *this) {                                    \
    ...
    return this->it.curr ? &(this->it.curr->data) : NULL;                                                    \
                                                                                                             ...
                                                                                                             \
void __htable_rehash_##id(TableType *this, size_t nbuckets);                                                 \
DataType *__htable_insert_##id(TableType *this, DataType data, int *inserted);                               \
void __htable_insert_fromArray_##id(TableType *this, DataType* arr, size_t n);                               \
TableType *__htable_new_fromArray_##id(DataType *arr, size_t n);                                             \
